...
public class LinearScalingFilterParams extends javax.swing.JPanel {

    private ShellWindow parent;
    private LinearScalingFilter algorithm;
    private final Logger logger = LoggerFactory.getLogger(LinearScalingFilterParams.class);
    
    public LinearScalingFilterParams(ShellWindow parent, LinearScalingFilter algorithm) {
        initComponents();
        this.parent = parent;
    ...
    private void b_ExecuteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_ExecuteActionPerformed
        ...
        try {
            ...
            if (algorithm.getResultingImage() != null) {
                algorithm = (LinearScalingFilter) algorithm.clone();
            }
